...
public:
	...
	void drawSplit(Vector2 targetLoc,Vector2 sourceLoc ,Sprite& sprite, float scaleDivide);
	...
	static void drawFromSpriteSheet(GraphicsBuffer& targetGraphicsBuffer, Vector2 targetImageLoc, Vector2 targetLoc, Sprite& sprite, Vector2 scale);
