...
void Unit::drawUnit(System* aSystem)
{
	...
	aSystem->getDisplay()->draw(mSourceX, mSourceY, mUnitAnimation.getCurrentSprite(), (double)1/2, 60, 60, mUnitAnimation.getCurrentSprite()->getSourceLocX(), mUnitAnimation.getCurrentSprite()->getSourceLocY());
}
