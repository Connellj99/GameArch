...
void GSystem::writeText(int locX, int locY, Font* font, int r, int g, int b, string message, int flag)
{
	ALLEGRO_COLOR color = al_map_rgb(r, g, b);

	al_draw_text(font->cour_font, color, locX, locY, flag, message.c_str());
}
...
ALLEGRO_BITMAP* GSystem::getBackBuffer()//Leaky
{
