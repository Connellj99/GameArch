...
Animation::Animation( GraphicsBuffer * spriteSheet, int spritesPerRow, int spritesPerColumn, Vector2 displayDimensions, Vector2 spriteDimensions )
{
	...
	{
		addSprite( new Sprite( new GraphicsBuffer( displayDimensions.mX, displayDimensions.mY, "GraphicsBuffer" ), SMURF_SPRITE_DISPLACEMENT_FOR_CENTERING_X, SMURF_SPRITE_DISPLACEMENT_FOR_CENTERING_Y, true, spriteDimensions) );
	}
