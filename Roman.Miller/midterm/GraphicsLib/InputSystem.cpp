...
void InputSystem::update()
{
	...
	currentKey.aDown = al_key_down(&mKeyboardState, A);
	currentKey.wDown = al_key_down(&mKeyboardState, W);
	currentKey.dDown = al_key_down(&mKeyboardState, D);
	
	currentKey.left = al_key_down(&mKeyboardState, kLEFT);
	currentKey.right = al_key_down(&mKeyboardState, kRIGHT);
	currentKey.up = al_key_down(&mKeyboardState, kUP);
	currentKey.down = al_key_down(&mKeyboardState, kDOWN);
