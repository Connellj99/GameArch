...
Unit::Unit(Animation animation, Vector2D position, string type)
{
	mType = type;
...
Unit::Unit(vector<Animation> animation, Vector2D position, string type)
{
	mType = type;
...
Unit::Unit(Animation animation, string type)
{
	mType = type;
	mAnimationsVec.push_back(animation);
}

Unit::Unit(vector<Animation> animation, string type)
{
	mType = type;
	mAnimationsVec = animation;
}
