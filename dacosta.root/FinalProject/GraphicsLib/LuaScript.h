...
extern "C"
{
	#include "luaforwindows-5.1.5-52\files\include\lua.h"
	#include "luaforwindows-5.1.5-52\files\include\lauxlib.h"
	#include "luaforwindows-5.1.5-52\files\include\lualib.h"
}
