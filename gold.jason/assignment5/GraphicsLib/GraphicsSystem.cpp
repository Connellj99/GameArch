...
void GraphicsSystem::WriteText(Font* font, Color color, std::string message, float x, float y)
{
	ALLEGRO_COLOR tempColor = al_map_rgb(color.getRed(), color.getGreen(), color.getBlue());
