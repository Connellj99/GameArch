...
int main()
{
	...
	{
		cout << "error initting audio codecs\n";
		system("pause");
		return 1;
	}
	...
	{
		cout << "error loading primitive addon\n";
		system("pause");
		return 1;
	}
	...
	//sample = al_load_sample((ASSET_PATH + SAMPLE_FILENAME).c_str());

	if (!(ASSET_PATH + SAMPLE_FILENAME).c_str()) {
		cout << "error initting Audio clip\n";
		system("pause");
		return 1;
	}
	...
	*/
	...
	al_draw_text(font, WHITE, LOC1_X, LOC1_Y, ALLEGRO_ALIGN_CENTER, "Welcome to Allegro!");
	al_draw_filled_circle(LOC2_X, LOC2_Y, CIRCLE_RADIUS, BLACK_TRANSPARENT);
	al_draw_text(font, PURPLE, LOC2_X, LOC2_Y, ALLEGRO_ALIGN_CENTER, "Welcome to Allegro!");
